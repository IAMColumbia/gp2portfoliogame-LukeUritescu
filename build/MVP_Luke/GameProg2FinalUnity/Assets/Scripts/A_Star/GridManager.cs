...
//Notice by Luke Uritescu
/// <summary>
/// WARNING!!!!!!!!!!!!!!!!!!!
/// THe GRIDSIZE height and width is determined by the column and row number times 2
/// SO if we put the numberOfRows at 150 then the highest x value we can go to on the world point for an object is 300
/// Same goes for numberOfColumns.
/// This is somewhat limiting and I want to adjust, however I find this to be a class C bug as I can easily work around it 
/// 
/// WARNING!!!!!!!!!!!!!!!!!!!
/// </summary>
